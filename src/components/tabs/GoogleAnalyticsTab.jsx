import { analyticsData as d } from '../../data/analytics'
...
export default function GoogleAnalyticsTab() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-slate-900">Google Analytics</h2>
        <p className="text-sm text-slate-400 mt-0.5">Website traffic & conversions · Last 8 weeks</p>
      </div>
